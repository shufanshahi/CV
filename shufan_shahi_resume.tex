...
\begin{itemize}
  \item CGPA: 3.55; coursework: Algorithms, Machine Learning, Deep Learning, Databases, and Networks.
\end{itemize}
\end{rSection}
...
\begin{itemize}
  \item Recommends anime by interest and supports discovery through an intelligent chatbot.
\end{itemize}
\end{rSection}
