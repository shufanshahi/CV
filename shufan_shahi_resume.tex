...
B.Sc. in Computer Science and Engineering \hfill \textbf{CGPA: 3.55} \\
...
\projectheading{DocuMind}{RAG Document Q\&A Assistant}{Python, LangChain, LlamaIndex, ChromaDB, Ollama}{%
...
\begin{itemize}
  \item Fine-tuned YOLO11L on Bangladesh traffic data to detect local vehicle classes and deployed the inference application with Flask and Docker.
\end{itemize}
...
\begin{itemize}
  \item Built AI modules for real-time financial tracking, risk alerts, customer segmentation, and forecasting.
\end{itemize}
\end{rSection}
